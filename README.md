...
• Designed and implemented a courses organization dashboard for internal use, helping organize and manage 
educational content using React.js, Supabase, and responsive UI components. 
• Built and launched the PodZ podcast web app using Next.js and Supabase, focusing on performance, accessibility, 
...
Technologies: Next.js, React.js, Tailwind CSS, Supabase, GSAP, Mixpanel, Stripe, PayPal
